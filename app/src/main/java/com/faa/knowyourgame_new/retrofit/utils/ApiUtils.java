...
public class ApiUtils {
    ...
    public static final String BASE_SERVER_QUESTION_IMAGE_DIR = "http://10.0.2.2:8000/images/questions/";
    public static final String BASE_SERVER_LEAGUE_IMAGE_DIR = "http://10.0.2.2:8000/images/league/";
